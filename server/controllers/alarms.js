...
router.get('/', (req, res) => {
    // Alarm.find({}, 'title description', function (error, alarms) {
    //     if (error) {
    //         console.error(error);
    //     }
    //     res.send({
...
router.put('/alarms/:id', (req, res) => {
    var db = req.db;
    Alarm.findById(req.params.id, 'title description', function (error, alarm) {
        if (error) {
            console.error(error);
        }
